...
#define L_UPPER 0.16 //上臂長
#define L_LOWER 0.25 //下臂長
#define WB 0.12  //底座正三角型重心到邊的長度
#define WP 0.02  //下方小正三角形重心到鞭長的長度
#define UP 0.025  //下方小正三角形重心到頂點的長度
#define SP 0.042  //下方正三角型的邊長
...
void ctrl_test(int d1,int d2,int d3)
{
